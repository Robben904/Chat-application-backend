...
$sql0 = "DELETE from password_resets WHERE email='$email'";
...
if ($stmt->rowCount() == 0) {
    ...
    $mail->Username = 'shresthagunjan904@gmail.com';   // SMTP username 
    $mail->Password = 'vyyoebviswztsxyz';   // SMTP password 
    $mail->SMTPSecure = 'tls';            // Enable TLS encryption, `ssl` also accepted 
    $mail->Port = 587;                    // TCP port to connect to 

    // Sender info 
    $mail->setFrom('shresthagunjan904@gmail.com', 'Talk to');
